...
<head>
	...
	<body>	
		<div>
			<form class="form-horizontal" action="insertDBattendancetch.php" method="post" >
			<input type="hidden" name="idstudent" value="<?php echo $data['idstudent'];?>" >
				<table  width="452" border="1" bordercolor="#10a0c5" align="center"  cellpadding="0" cellspacing="1"  bgcolor="#000" style="padding: 2px">
					<tr>
						<td  height="40" align="center"  bgcolor="#10a0c5"><font  color="#FFFFFF">
						<b>Student Info</b></font></td>
					</tr>
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									<td align="left" class="lf">IC Number</td>
									<td style="font-weight:bold">:</td>
