<%-- 
    Document   : registerstd
    Created on : Oct 9, 2020, 10:38:01 AM
    Author     : USER
--%>
...
.center{
 ...
 <div class="center">
  <form action="processstd.jsp" method="post">
    
    <label for="fname">Name</label>
    <input type="text" id="nama" name="nama" placeholder="Student name..">

    <label for="lname">IC Number</label>
    <input type="text" id="telefon" name="telefon" placeholder="IC Number..">
    
    <label for="lname">Class</label>
    <input type="text" id="email" name="email" placeholder="Class..">
    
    <label for="lname">Card UID</label>
    <input type="text" id="class" name="class" placeholder="Card uid..">
