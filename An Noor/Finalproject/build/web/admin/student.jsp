<%-- 
    Document   : student
    Created on : Oct 9, 2020, 10:32:39 AM
    Author     : USER
--%>
...
th {
 ...
 <td>
 <a href="updatestd.jsp?idstudent=<%=rs.getString("idstudent")%>">Edit</a>
 
 <a href="deletestd.jsp?idstudent=<%=rs.getString("idstudent")%>">Delete</a>
 </td>
 </tr>
 <%
 }
